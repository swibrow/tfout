...
```bash
# List releases
helm history tfout --namespace tfout

# Rollback to previous version
helm rollback tfout 1 --namespace tfout
```
...
2. **Permission Issues**
   ...
   kubectl get serviceaccount -n tfout

   # Check RBAC
   kubectl auth can-i create configmaps --as=system:serviceaccount:tfout:tfout
   ```
